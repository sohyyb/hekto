<template>
    ...
    <div class="shopLeft">
        ...
        <div class="link">
            <a href="">Home</a>
            <a href="">Pages</a>
            <a @click.prevent="showNavs = !showNavs" href="">Shop Left </a>
        </div>
        <Transition>
...
import { Check, Star, ShoppingCart, Heart, ZoomIn } from '@vicons/tabler';
import { NIcon } from "naive-ui"
import { ref } from 'vue';
import axios from 'axios';
const showNavs = ref(false)
const shopLeft = ref([])
const getshopLeft = await axios.get("http://localhost:3000/api/shopLeft")
shopLeft.value = getshopLeft.data
</script>
<style>
.v-enter-active,
.v-leave-active {
